"""
Zenodo - EMG gesture recognition dataset (record 7637557).

Specs: EMG data for gesture classification tasks
...
def download_zenodo(data_root = "./data"):
    try:
        ...
        url = "https://zenodo.org/records/7637557/files/emg-gesture-recognition-master.zip"
        zip_path = raw_dir / "zenodo.zip"
...
if __name__ == "__main__":
    download_zenodo(data_root="/scratch/klambert/sEMG")
