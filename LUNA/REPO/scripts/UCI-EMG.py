"""
UCI-EMG - EMG data for gestures from UCI Machine Learning Repository.

Specs: sEMG recordings for hand gesture classification tasks
Format: ZIP archive from UCI repository
Size: N/A
"""
import os
import requests 
...
if __name__ == "__main__":
    download_uci_emg(data_root="/scratch/klambert/sEMG")
